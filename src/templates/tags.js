    ...
    const postLinks = posts.map(post => (
      <li key={post.node.fields.slug}>
        <Link to={post.node.fields.slug}>
          <h2 className="inline-block font-semibold text-blue-400 hover:text-blue-600 focus:outline-none focus:bg-blue-600 rounded px-5 mt-1 ">
      ...
      <Layout>
        <section className="bg-gray-100">
          ...
          <div className="max-w-xl px-4 py-16 mx-auto">
            <h3 className="text-blue-grey-200 text-lg sm:text-3xl font-semibold">
              {tagHeader}
            </h3>
